...
class _IntelligenceScreenState extends ConsumerState<IntelligenceScreen>
  ...
  // Colour follows the model's risk label. The score itself is a SAFETY value
  // (high = safe), so thresholding it directly would invert the meaning.
  Color _riskColor(RiskScore rs) {
    switch (rs.level) {
      case RiskLevel.high:
